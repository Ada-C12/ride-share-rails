...
describe TripsController do
  ...
  describe "update from edit form" do
    ...
    # it "does not update a trip if the form data does not fulfill validation requirements, and responds with a redirect" do
    #   no_date_hash = {
    #     trip: {
    #       date: nil,
    #       passenger_id: Passenger.first.id,
    ...
    #   expect {
    #     patch trip_path(@trip.id), params: no_date_hash
    #   }.wont_change "Trip.count"
