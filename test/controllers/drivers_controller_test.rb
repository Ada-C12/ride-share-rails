...
describe DriversController do
  ...
  describe "show" do
    ...
    it "responds with 404 with an invalid driver id" do
      ...
      must_redirect_to nope_path(msg: "Driver does not exist")
    end
  end
  ...
  describe "create" do
    it "can create a new driver with valid information accurately, and redirect" do
      driver_hash = { driver: { name: "Home Dawg", vin: "098" }}
  ...
  it "does not create a driver if the form data violates Driver validations, and responds with a render" do
    ...
    bad_names.each do |bad_name|
      new_driver_hash = { driver: { name: bad_name, vin: "123" }}  
      expect { post drivers_path, params: new_driver_hash }.must_differ 'Driver.count', 0
      must_respond_with 200
    end
    
    bad_vins = ["", nil, "    "]
    bad_vins.each do |bad_vin|
      new_driver_hash = { driver: { name: "abc", vin: bad_vin }}  
      expect { post drivers_path, params: new_driver_hash }.must_differ 'Driver.count', 0
      must_respond_with 200
    end
    ...
    bad_names = ["", nil, "    "]
    3.times do |index|
      new_driver_hash = { driver: { name: bad_names[index], vin: bad_vins[index] }}  
      expect { post drivers_path, params: new_driver_hash }.must_differ 'Driver.count', 0
      must_respond_with 200
    end
  end
...
describe "update" do
  it "can update an existing driver with valid information accurately, and redirect" do
    existing_driver = Driver.create(name: "Kari", vin: "123")
    updated_driver_data = { driver: { name: "Not Kari haha", vin: "987" } }
    
    expect { patch driver_path(id: existing_driver.id), params: updated_driver_data }.must_differ 'Driver.count', 0
  ...
  it "does not update any driver if given an invalid id, and responds with a 404" do
    patch driver_path(-777), params: { driver: { name: "Not Kari haha", vin: "987" }}
  ...
  it "does not update a driver if the form data violates Driver validations, and responds with a redirect" do
    existing_driver = Driver.create(name: "Kari", vin: "123")
    updated_driver_data = { driver: { name: "", vin: "", active: false, }}
...
describe "destroy" do
  it "destroys the driver instance in db when driver exists, then redirects" do
    ...
    expect { delete driver_path(existing_driver.id) }.must_differ "Driver.count", -1
  ...
  it "does not change the db when the driver does not exist, then responds with " do
    ...
    expect { delete driver_path(777) }.must_differ "Driver.count", 0
...
describe "active" do
  it "should mark driver.active to true or false" do
    ...
    updated_active_status = { driver: { active: true}}
