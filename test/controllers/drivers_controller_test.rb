...
describe DriversController do
  ...
  let (:driver_barney) { Driver.create(name: "Barney Rubble", vin: "456", car_make: "bird", car_model: "robin", available: false) }
  ...
  describe "update" do
    it "can update an existing driver with valid information accurately, and redirect" do
      ...
      expect(updated_driver.available).must_equal changes[:driver][:available]
  ...
  describe "toggle" do
    it "changes a driver from available to unavailable" do
      original_driver = driver_fred
      
      patch toggle_path(original_driver.id)
    ...
    it "changes a driver from unavailable to available" do
      original_driver = driver_barney
