...
describe DriversController do
  ...
  describe "index" do
    it "responds with success when there are many drivers saved" do
      ...
      test_driver_too = Driver.create(name: "Olive Oil", vin: "8FH204KDLFUR53385")
      get drivers_path
  ...
  describe "update" do
    it "can update an existing driver with valid information accurately, and redirect" do
      ...
      driver = Driver.create(name: "Popeye Sailor", vin: "568856")
      
      id = driver.id
      params = { driver: { vin: 568856254423 } }
  ...
  describe "destroy" do
    it "destroys the driver instance in db when driver exists, then redirects" do
      ...
      expect{ delete driver_path(Driver.first.id)}.must_change "Driver.count", -1
