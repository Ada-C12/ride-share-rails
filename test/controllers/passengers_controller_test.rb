...
patch "/passengers/#{new_passenger.id}", params: updated_passenger_form_data

expect(Passenger.find_by(id: new_passenger.id).name).must_equal "updated passenger"
expect(Passenger.find_by(id: new_passenger.id).phone_num).must_equal "44444444"
end
